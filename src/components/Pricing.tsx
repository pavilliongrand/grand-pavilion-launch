                ...
                <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-[#A3E635] text-[#1A2E05]">
                                    <th className="p-6 font-heading font-bold text-lg tracking-wide border-b border-[#84cc16]/20">Time Slot</th>
                                    <th className="p-6 font-heading font-bold text-lg tracking-wide border-b border-[#84cc16]/20">Cricket (2 Hrs)</th>
                                    <th className="p-6 font-heading font-bold text-lg tracking-wide border-b border-[#84cc16]/20">Football (1 Hr)</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-100">
                                {pricingData.map((row, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="p-6 font-mono font-bold text-gray-900">{row.cricket}</td>
                                        <td className="p-6 font-mono font-bold text-gray-900">{row.football}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="p-6 bg-gray-50 border-t border-gray-100 flex items-start gap-3 text-sm text-gray-500">
                        <Info className="w-5 h-5 text-[#84cc16] flex-shrink-0 mt-0.5" />
